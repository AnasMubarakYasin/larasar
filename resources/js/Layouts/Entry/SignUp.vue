        ...
        <div class="w-screen h-screen grid place-content-center bg-gray-50">
            ...
            >
                ...
                <div class="grid gap-2 justify-items-center">
                    ...
                    <div class="text-xl font-bold mb-4">Sign Up</div>
                </div>
                <q-form class="w-full grid gap-2" @submit.prevent="submit">
                    ...
                    <q-input
                        ...
                        :type="
                            helper.password_confirmation ? 'text' : 'password'
                        "
                        :disabled="form.processing"
                    ...
                    <div class="flex gap-2">
                        ...
                        <Link :href="entry.signin()" class="text-blue-700 hover:underline"
                            >Sign In</Link
                        >
                    </div>
                </q-form>
